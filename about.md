...
Hi there! My name is Ulad and I work as a senior software engineer. As you could guess based on your address line, my main technical passion is .NET. However, my technical stack includes also React, Microsoft Azure, GCP, Kubernetes, MSSQL, MongoDB, RabbitMQ.

Recently I significantly expanded into AI Engineering and was able to get hands-on experience of LLM integrations, RAG architectures and AI agentic solutions. 

{{ site.badges.dotnet }}
{{ site.badges.azure }}
{{ site.badges.react }}
{{ site.badges.k8s }}
{{ site.badges.aiengineering }}
...
It was a fascinating experience to dive deeper into k8s world and explore an insane level of control over your resources.

### What inspires me

Learning something new definitely inspires me the most. As a software engineer, I regularly face complex tasks filled with unknowns. Solving these technical puzzles often requires exploring and mastering entirely new areas of knowledge, which makes the process both challenging and rewarding. **Continuous learning is at the core of who I am.**

Another important aspect for me is active participation in technical interviews and assessments. I strongly believe that working as a technical interviewer helps me stay sharp, continuously improve my skills, and keep up with modern industry trends.
